                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8">
                            ...
                            <div class="post">
                              ...
                              <form action="ForumServlet" class="form newtopic" method="post">
                                    <div class="topwrap">
                                        ...
                                        <div class="posttext pull-left">
                                            ...
                                            <div>
                                                <input type="text" placeholder="Enter Topic Title" class="form-control" name="f_title"/>
                                            </div>

                                            <div class="row">
                                                <div class="col-lg-6 col-md-6">
                                                    <select name="f_cat" id="category"  class="form-control" >
                                                ...
                                                <div class="col-lg-6 col-md-6">
                                                    <select name="f_lang" id="Language"  class="form-control" >
                                            ...
                                            <div>
                                                <textarea name="f_content" id="desc" placeholder="Post content"  class="form-control" ></textarea>
                                            </div>
