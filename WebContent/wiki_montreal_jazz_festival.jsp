...
<title>Montreal International Jazz Festival</title>
        <!-- Bootstrap core CSS -->
    ...
    <div class="container"  style="padding-left: 254px;">
      ...
      <div class="row">
        ...
        <div class="col-lg-9">
          ...
          <div class="card mt-4">
            <img class="card-img-top img-fluid" src="images/montreal-jazz-festival2.jpg" alt="">
            <div class="card-body">
              <h3 class="card-title">Montreal International Jazz Festival</h3>
