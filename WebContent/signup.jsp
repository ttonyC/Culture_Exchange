...
<html>
 <head>
		...
		<title>Cultural Exchange-Sign Up</title>
        <!-- Bootstrap core CSS -->
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-10 mx-auto">
                        <div class="page-heading">
                            <h1>Join Us</h1>
                            <span class="subheading">to have fun from now on!</span>
                        </div>
                    </div>
                </div>
            </div>
					...
					<form action="RegisterServlet" method="post" class="container">
						<div class="control-group">
                            <div class="form-group floating-label-form-group controls">
                                ...
                                <input type="text" class="form-control" placeholder="fname" name="fname" required data-validation-required-message="Please enter your name.">
                        ...
                        <div class="control-group">
                            <div class="form-group floating-label-form-group controls">
                                ...
                                <input type="text" class="form-control" placeholder="lname" name="lname" required data-validation-required-message="Please enter your name.">
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <div class="control-group">
