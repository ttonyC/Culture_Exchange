...
<title>Canadian National Exhibition</title>
        <!-- Bootstrap core CSS -->
    ...
    <div class="container"  style="padding-left: 254px;">
      ...
      <div class="row">
        ...
        <div class="col-lg-9">
          ...
          <div class="card mt-4">
            <img class="card-img-top img-fluid" src="images/Canadian_National_Exhibition2.JPG" alt="">
            <div class="card-body">
              <h3 class="card-title">Canadian National Exhibition</h3>
